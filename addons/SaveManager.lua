...
local SaveManager = {} do
    ...
    function SaveManager:Save(name)
        ...
        local success2, encoded2 = pcall(HttpService.JSONEncode, HttpService, data)
        if success2 then encoded = encoded2 end
    ...
    function SaveManager:Load(name)
        ...
        if self.CustomLoad and decoded.custom then
            task.spawn(self.CustomLoad, decoded.custom)
        end
